...
resource "aws_ecs_service" "teletracker-qa-consumer-ec2" {
  name            = "teletracker-qa-consumer-ec2_v2"
  cluster         = aws_ecs_cluster.teletracker-qa.id
  task_definition = aws_ecs_task_definition.teletracker-qa-consumer-ec2.arn
  desired_count   = 0
