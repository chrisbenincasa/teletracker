...
class UserTrackedLists @Inject()(
  ...
  class UserTrackedListsTable(tag: Tag) extends Table[UserTrackedList](tag, "user_tracked_lists") {
    def userId = column[Int]("user_id")
    def listId = column[Int]("list_id")

    def list = foreignKey("user_lists_list_id_fk", listId, trackedLists.query)(_.id)
