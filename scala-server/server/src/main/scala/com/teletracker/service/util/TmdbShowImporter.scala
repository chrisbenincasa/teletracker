...
import com.teletracker.service.db.{NetworksDbAccess, ThingsDbAccess, TvShowDbAccess}
import com.teletracker.service.external.justwatch.JustWatchClient
import com.teletracker.service.external.tmdb.TmdbClient
import com.teletracker.service.model.justwatch.{JustWatchSeason, JustWatchShow, PopularItem, PopularItemsResponse, _}
import com.teletracker.service.model.tmdb.{TvShow, TvShowSeason => TmdbTvShowSeason}
...
class TmdbShowImporter @Inject()(
  ...
  def handleShows(shows: List[TvShow], pullSeasons: Boolean, pullAvailability: Boolean) = {
