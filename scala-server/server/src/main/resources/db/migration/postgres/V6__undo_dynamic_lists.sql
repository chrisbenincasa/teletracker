...
ALTER TABLE "lists" ADD COLUMN "is_dynamic" BOOLEAN DEFAULT FALSE;
ALTER TABLE "lists" ADD COLUMN "rules" JSONB;

DROP INDEX "lists_by_user";
CREATE INDEX "lists_by_user" ON "lists" ("user_id", "is_dynamic");

ALTER TABLE "lists" ADD CONSTRAINT dynamic_lists_must_have_rules
