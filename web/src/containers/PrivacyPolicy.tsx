...
export default function PrivacyPolicy() {
  ...
  return (
    <div className={classes.wrapper}>
      ...
      <p>
        At Telescope, accessible from http://TelescopeTV.com, one of our main
        priorities is the privacy of our visitors. This Privacy Policy document
        contains types of information that is collected and recorded by
        Telescope and how we use it. If you have additional questions or require
        ...
        they shared and/or collect in Telescope. This policy is not applicable
      ...
      <p>
        ...
        <ul>
          ...
          <li>
            Understand and analyze how you use our webste Develop new products,
      ...
      <h3>Log Files</h3>
      <p>
        Telescope follows a standard procedure of using log files. These files
      ...
      <p>
        Like any other website, Telescope uses 'cookies'. These cookies are used
      ...
      <p>
        We do not allow the collection of any data from any of our visitors for
        any reason.
      </p>
      ...
      <p>
        ...
        Telescope does not knowingly collect any Personal Identifiable
